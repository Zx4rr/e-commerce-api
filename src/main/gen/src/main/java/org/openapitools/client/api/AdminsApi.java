...
public class AdminsApi {
     ...
     */
    public okhttp3.Call addInventoryCall(InventoryItem inventoryItem, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call addInventoryValidateBeforeCall(InventoryItem inventoryItem, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = addInventoryCall(inventoryItem, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> addInventoryWithHttpInfo(InventoryItem inventoryItem) throws ApiException {
        okhttp3.Call localVarCall = addInventoryValidateBeforeCall(inventoryItem, null);
     ...
     */
    public okhttp3.Call addInventoryAsync(InventoryItem inventoryItem, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addInventoryValidateBeforeCall(inventoryItem, _callback);
